...
`,
    ...
    detailImages: [
      ...
      "/Website/img/mh/MA-01.png",
      "/Website/img/mh/MA-02.png",
      "/Website/img/mh/MA-03.png",
      "/Website/img/mh/MA-04.png",
      "/Website/img/mh/MA-AR1.png",
    ],
  },
  {
    id: "BDZ",
...
`,
    ...
    detailImages: [
      "/Website/img/mh/GPS.png",
      "/Website/img/mh/BOCH-01.png",
      "/Website/img/mh/BOCH-02.png",
      "/Website/img/mh/BOCH-03.png",
      "/Website/img/mh/BOCH-04.png",
...
`,
    technologies: ["Unity", "AR"],
    layout: "video",
    thumbnailUrl: "/Website/img/mh/Honka.png",
    videoUrl: "https://www.youtube.com/embed/8IWW6t6Y5zo?si=DrBvGKZqyW-T7tzC",
    detailImages: [
      "/Website/img/mh/GPS.png",
      "/Website/img/mh/HHHonka-1.png",
      "/Website/img/mh/HHHonka-2.png",
      "/Website/img/mh/HHHonka-3.png",
...
Advanced augmented reality with image detection enhances immersion by triggering riddle logic and accurately placing 3D objects in the environment. Players scan specific markers or clues, activating hidden puzzles and animations that respond to their actions. This dynamic interaction turns the surroundings into an evolving landscape, creating a memorable experience where solving each challenge propels the story forward in this Unity-powered journey through historical investigation.`,
    ...
    detailImages: [
      "/Website/img/mh/GPS.png",
      "/Website/img/mh/IBDWM-R2.png",
      "/Website/img/mh/IBDWM-R3.png",
      "/Website/img/mh/IBDWM-R1.png",
      "/Website/img/mh/IBDWM-AR0.png",
      "/Website/img/mh/IBDWM-AR1.png",
...
The project was developed in collaboration with Marina Engelhardt and Nora Schiller.`,
  ...
  },
  {
    ...
    technologies: ["TouchDesigner"],
    layout: "video",
    thumbnailUrl: "/Website/img/int_portfolio/1.jpg",
    videoUrl: "https://player.vimeo.com/video/766090078?h=486626679e",

    detailImages: [
      "/Website/img/int_portfolio/1s.jpg",
      "/Website/img/int_portfolio/2s.jpg",
      "/Website/img/int_portfolio/3s.jpg",
      "/Website/img/int_portfolio/4s.jpg",
      "/Website/img/int_portfolio/5s.jpg",
      "/Website/img/int_portfolio/6s.jpg",
      "/Website/img/int_portfolio/7s.jpg",
      "/Website/img/int_portfolio/8s.jpg",
    ],
  },
  {
    id: "Bursting glass",
