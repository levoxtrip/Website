...
`,
    ...
    detailImages: [
      "/assets/img/mh/GPS.png",
      "/assets/img/mh/MA-01.png",
      "/assets/img/mh/MA-02.png",
      "/assets/img/mh/MA-03.png",
      "/assets/img/mh/MA-04.png",
      "/assets/img/mh/MA-AR1.png",
    ],
  },
  {
    id: "BDZ",
...
`,
    ...
    detailImages: [
      "/assets/img/mh/GPS.png",
      "/assets/img/mh/BOCH-01.png",
      "/assets/img/mh/BOCH-02.png",
      "/assets/img/mh/BOCH-03.png",
      "/assets/img/mh/BOCH-04.png",
      "/assets/img/mh/BOCH-05.png",
      "/assets/img/mh/BOCH-06.png",
    ],
...
`,
    technologies: ["Unity", "AR"],
    layout: "video",
    thumbnailUrl: "/assets/img/mh/Honka.png",
    videoUrl: "https://www.youtube.com/embed/8IWW6t6Y5zo?si=DrBvGKZqyW-T7tzC",
    detailImages: [
      "/assets/img/mh/GPS.png",
      "/assets/img/mh/HHHonka-1.png",
      "/assets/img/mh/HHHonka-2.png",
      "/assets/img/mh/HHHonka-3.png",
      "/assets/img/mh/HHHonka-4.png",
      "/assets/img/mh/HHHonka-AR0.png",
    ],
...
Advanced augmented reality with image detection enhances immersion by triggering riddle logic and accurately placing 3D objects in the environment. Players scan specific markers or clues, activating hidden puzzles and animations that respond to their actions. This dynamic interaction turns the surroundings into an evolving landscape, creating a memorable experience where solving each challenge propels the story forward in this Unity-powered journey through historical investigation.`,
    technologies: ["Unity", "AR"],
    layout: "video",
    thumbnailUrl: "/assets/img/mh/IBDWM_head.png",
    videoUrl: "https://www.youtube.com/embed/-JDDWyWVsJw?si=mm1btCL_vQofQz6C",
    detailImages: [
      "/assets/img/mh/GPS.png",
      "/assets/img/mh/IBDWM-R2.png",
      "/assets/img/mh/IBDWM-R3.png",
      "/assets/img/mh/IBDWM-R1.png",
      "/assets/img/mh/IBDWM-AR0.png",
      "/assets/img/mh/IBDWM-AR1.png",
      "/assets/img/mh/IBDWM-AR2.png",
      "/assets/img/mh/IBDWM-AR3.png",
    ],
...
LiDAR sensor system that captures the player movements, translating them into real-time gameplay elements. The installation features generative visuals and audio-reactive lighting created in TouchDesigner, projected across the space using a multi-projector setup.
  ...
  - Run from side to side: The user has to run from side to side to collect as much points as possible in a certain time frame.
    ...
    layout: "video",
    thumbnailUrl:"/assets/img/SpacialARGames/corre/4.png",
    videoUrl: "https://www.youtube.com/embed/8ECLjSvQmgQ?si=icuIO5hmLXfGgju2",
    detailImages: [
      "/assets/img/SpacialARGames/setup/1.png",
      "/assets/img/SpacialARGames/setup/2.png",
      "/assets/img/SpacialARGames/setup/td5.png",
      "/assets/img/SpacialARGames/setup/td6.png",
      "/assets/img/SpacialARGames/corre/1.png",
      "/assets/img/SpacialARGames/corre/2.png",
      "/assets/img/SpacialARGames/corre/3.png",
      "/assets/img/SpacialARGames/corre/5.png",
      "/assets/img/SpacialARGames/corre/7.png",
      "/assets/img/SpacialARGames/bubbles/1.png",
      "/assets/img/SpacialARGames/bubbles/2.png",
      "/assets/img/SpacialARGames/bubbles/3.png",
      "/assets/img/SpacialARGames/lava/1.png",
      "/assets/img/SpacialARGames/lava/2.png",
      "/assets/img/SpacialARGames/lava/3.png",
      "/assets/img/SpacialARGames/blocks/1.png",
      "/assets/img/SpacialARGames/blocks/2.png",
      "/assets/img/SpacialARGames/blocks/3.png",
  ...
  },
  {
    ...
    layout: "video",
    thumbnailUrl: "/assets/img/img/10xcc.jpeg",
...

  {
    ...
    layout: "video",
    thumbnailUrl: "/assets/img/Refracta/1.JPG",
    videoUrl: "https://www.youtube.com/embed/zPJsoc-IDcs?si=LHhFuVO1KMnV3h6t",
    
    detailImages: [
      "/assets/img/Refracta/2.JPG",
      "/assets/img/Refracta/3.JPG",
      "/assets/img/Refracta/4.png",
      "/assets/img/Refracta/5.png",
      "/assets/img/Refracta/6.png",
      "/assets/img/Refracta/7.png",
      "/assets/img/Refracta/8.png",
    ],
  ...
  },
  {
    ...
    layout: "video",
    thumbnailUrl: "/assets/img/levoxtrip/GoExplora-Earth.png",
  ...
  },
  {
    ...
    layout: "video",
    thumbnailUrl: "/assets/img/levoxtrip/Inferno.png",
  ...
  },
  {
    ...
    technologies: ["Javascript", "P5.js"],
    layout: "video",
    thumbnailUrl: "/assets/img/levoxtrip/ColoringCode.png",
    videoUrl: "https://www.youtube.com/embed/TJ7hZ3tDyaY?si=AhEPncaKshHqvLa6",
    detailImages: [],
...
This project has be exhibited at the ars electronica satellite event 2021 in Berlin.`,
    ...
    layout: "standard",
    thumbnailUrl: "/assets/img/sensus_autem_machina/thum.jpg",
    detailImages: [
      "/assets/img/sensus_autem_machina/sensur1.jpg",
      "/assets/img/sensus_autem_machina/sensus2.jpg",
      "/assets/img/sensus_autem_machina/sensus3.jpg",
      "/assets/img/sensus_autem_machina/sensus4.jpg",
      "/assets/img/sensus_autem_machina/7_sensus_ars4.png",
      "/assets/img/sensus_autem_machina/7_sensus_ars5.png",
      "/assets/img/sensus_autem_machina/7_sensus_ars6.png",
      "/assets/img/sensus_autem_machina/7_sensus_ars7.png",
      "/assets/img/sensus_autem_machina/7_sensus_ars8.png",
    ],
  },
  {
    id: "Did they meet",
...
The project was developed in collaboration with Marina Engelhardt and Nora Schiller.`,
    technologies: ["Processing", "Installation"],
    layout: "standard",
    thumbnailUrl: "/assets/img/Poetic_interfaces/7.jpg",
    detailImages: [
      "/assets/img/Poetic_interfaces/7.jpg",
      "/assets/img/Poetic_interfaces/1.jpg",
      "/assets/img/Poetic_interfaces/2.jpg",
      "/assets/img/Poetic_interfaces/3.png",
    ],
  },
  {
    id: "InterPortfolio",
    title: "Interactive Portfolio",
    shortDescription: `An interactive portfolio made in TouchDesigner.`,
    description: `In this project, I created an interactive portfolio in Touchdesigner. The viewer can interactively navigate through my presented project with the mouse of the computer. It is also possible to change the language of the texts and to zoom in the images via click. Certain parts of the content also change depending on the user behavior.`,
    technologies: ["TouchDesigner"],
    layout: "video",
    thumbnailUrl: "/assets/img/int_portfolio/1.jpg",
    videoUrl: "https://player.vimeo.com/video/766090078?h=486626679e",

    detailImages: [
      "/assets/img/int_portfolio/1s.jpg",
      "/assets/img/int_portfolio/2s.jpg",
      "/assets/img/int_portfolio/3s.jpg",
      "/assets/img/int_portfolio/4s.jpg",
      "/assets/img/int_portfolio/5s.jpg",
      "/assets/img/int_portfolio/6s.jpg",
      "/assets/img/int_portfolio/7s.jpg",
      "/assets/img/int_portfolio/8s.jpg",
    ],
  },
  {
    id: "Bursting glass",
    ...
    layout: "video",
    thumbnailUrl: "/assets/img/bursting_glas/6.jpg",
    videoUrl: "https://www.youtube.com/embed/ktTrWckY2iY",
    detailImages: [
      "/assets/img/bursting_glas/1.jpg",
      "/assets/img/bursting_glas/2.jpg",
      "/assets/img/bursting_glas/3.jpg",
      "/assets/img/bursting_glas/5.jpg",
      "/assets/img/bursting_glas/6.jpg",
    ],
  },
  {
    id: "N_FXTURE",
    title: "N_FXTURE",
    shortDescription: `The Color of the city is an interactive multimedia installation that invites the audience to explore the colorful urban life of Mexico City.`,
    ...
    layout: "video",
    thumbnailUrl: "/assets/img/N_FXTURE/4_s.jpg",
    videoUrl:
      "https://player.vimeo.com/video/775036275?h=ffae6baa70&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479",
    detailImages: [
      "/assets/img/N_FXTURE/1_s.jpg",
      "/assets/img/N_FXTURE/2_s.jpg",
      "/assets/img/N_FXTURE/3_s.jpg",
      "/assets/img/N_FXTURE/4_s.jpg",
      "/assets/img/N_FXTURE/5_s.jpg",
      "/assets/img/N_FXTURE/6_s.jpg",
      "/assets/img/N_FXTURE/7_s.jpg",
    ],
  },
  {
    id: "transmorphosis",
...
The virtual reality project "transmorphosis" is a 360° VR video that deals with the situation how a world could look like, that has been completely overhauled by humans towards themselves. It further raises the questions how the relationships between people and their environment and nature would develop under these new circumstances. To emphasize the notion that for many advocates of the Anthropocene hypothesis, the main culprits, the western industrialized nations and their "technocratic elite[s]" are—I consciously chose "white" skin color for this project.`,
    technologies: ["Blender"],
    layout: "video",
    thumbnailUrl: "/assets/img/transmorphosis/2_s.jpg",
    videoUrl: "https://www.youtube.com/embed/m72GJQdn4LQ?si=t0BZTZ_bD1Esy9_L",
    detailImages: [
      "/assets/img/transmorphosis/1_s.jpg",
      "/assets/img/transmorphosis/2_s.jpg",
      "/assets/img/transmorphosis/3_s.jpg",
      "/assets/img/transmorphosis/4_s.jpg",
      "/assets/img/transmorphosis/5_s.jpg",
      "/assets/img/transmorphosis/6_s.jpg",
      "/assets/img/transmorphosis/7_s.jpg",
      "/assets/img/transmorphosis/8_s.jpg",
      "/assets/img/transmorphosis/9_s.jpg",
    ],
    url: "https://www.youtube.com/embed/m72GJQdn4LQ?si=t0BZTZ_bD1Esy9_L",
  },
  {
    id: "[PART]",
    title: "[PART]",
...
Painting by Dennis Henning. Sound by Samuele Nestola. Project was realized in Unity and Blender.`,
    technologies: ["Unity", "Blender", "AR"],
    layout: "video",
    thumbnailUrl: "/assets/img/[part]/1_s.jpg",
    videoUrl: "https://www.youtube.com/embed/PV7DTLJT1OY?si=hIUkf57NrxT6XcHj",
    url: "https://www.youtube.com/watch?v=PV7DTLJT1OY",
    detailImages: [
      "/assets/img/[part]/1_s.jpg",
      "/assets/img/[part]/2_s.jpg",
      "/assets/img/[part]/3_s.jpg",
      "/assets/img/[part]/4_s.jpg",
      "/assets/img/[part]/5_s.jpg",
      "/assets/img/[part]/6_s.jpg",
      "/assets/img/[part]/7_s.jpg",
      "/assets/img/[part]/8_s.jpg",
      "/assets/img/[part]/9_s.jpg",
    ],
  },
  {
    id: "Shift Space",
...
We curated a selection of the artists works for the exhibition ourselves as part of the project.
    ...
    technologies: ["Unity"],
    layout: "standard",
    thumbnailUrl: "/assets/img/shift_space/1.png",
    detailImages: [
      "/assets/img/shift_space/1.png",
      "/assets/img/shift_space/2.png",
      "/assets/img/shift_space/11.png",
      "/assets/img/shift_space/12.png",
      "/assets/img/shift_space/14.png",
    ],
    url: "https://the-shift-space.vercel.app/",
  },
  {
    id: "ColorOfCity",
    ...
    layout: "standard",
    thumbnailUrl: "/assets/img/Color_City/1.jpg",
    detailImages: [
      "/assets/img/Color_City/1.jpg",
      "/assets/img/Color_City/2.jpg",
      "/assets/img/Color_City/3.jpg",
      "/assets/img/Color_City/4.jpg",
    ],
  },
  {
    ...
    technologies: ["TouchDesigner", "Installation"],
    layout: "standard",
    thumbnailUrl: "/assets/img/gloomy_prospects/5.png",
    detailImages: [
      "/assets/img/gloomy_prospects/4.jpg",
      "/assets/img/gloomy_prospects/5.png",
      "/assets/img/gloomy_prospects/Inside_portfolio_eng.jpg",
      "/assets/img/gloomy_prospects/outside_3_final.png",
    ],
  },
];
