...
export const projects: ProjectData[] = [
...

  {
    ...
    layout: 'video',
    thumbnailUrl: 'src/assets/img/levoxtrip/GoExplora-Earth.png',
  ...
  },
  {
    ...
    technologies: ['Javascript','P5js'],
    layout: 'video',
    thumbnailUrl: 'src/assets/img/levoxtrip/Inferno.png',
  ...
  },
  {
    ...
    technologies: ['Javascript','P5js'],
    layout: 'video',
    thumbnailUrl: 'src/assets/img/levoxtrip/ColoringCode.png',
...
This project has be exhibited at the ars electronica satellite event 2021 in Berlin.`,
    technologies: ['Python'],
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/sensus_autem_machina/thum.jpg',
    detailImages: [
      'src/assets/img/sensus_autem_machina/sensur1.jpg',
      'src/assets/img/sensus_autem_machina/sensus2.jpg',
      'src/assets/img/sensus_autem_machina/sensus3.jpg',
      'src/assets/img/sensus_autem_machina/sensus4.jpg',
      'src/assets/img/sensus_autem_machina/7_sensus_ars4.png',
      'src/assets/img/sensus_autem_machina/7_sensus_ars5.png',
      'src/assets/img/sensus_autem_machina/7_sensus_ars6.png',
      'src/assets/img/sensus_autem_machina/7_sensus_ars7.png',
      'src/assets/img/sensus_autem_machina/7_sensus_ars8.png'
    ],
    githubUrl: ''
  },
  {
...
The project was developed in collaboration with Marina Engelhardt and Nora Schiller.`,
    ...
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/Poetic_interfaces/7.jpg',
    detailImages: [
      'src/assets/img/Poetic_interfaces/7.jpg',
      'src/assets/img/Poetic_interfaces/1.jpg',
      'src/assets/img/Poetic_interfaces/2.jpg',
      'src/assets/img/Poetic_interfaces/3.png',
  ...
  ,
  {
    ...
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/bursting_glas/6.jpg',
    detailImages: [
      'src/assets/img/bursting_glas/1.jpg',
      'src/assets/img/bursting_glas/2.jpg',
      'src/assets/img/bursting_glas/3.jpg',
      'src/assets/img/bursting_glas/5.jpg',
      'src/assets/img/bursting_glas/6.jpg',
    ],
    githubUrl: 'https://github.com/yourusername/project1'
  },
  {
    ...
    layout: 'video',
    thumbnailUrl: 'src/assets/img/N_FXTURE/4_s.jpg',
    videoUrl: 'https://player.vimeo.com/video/775036275?h=ffae6baa70&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479',
    detailImages: [
      'src/assets/img/N_FXTURE/1_s.jpg',
      'src/assets/img/N_FXTURE/2_s.jpg',
      'src/assets/img/N_FXTURE/3_s.jpg',
      'src/assets/img/N_FXTURE/4_s.jpg',
      'src/assets/img/N_FXTURE/5_s.jpg',
      'src/assets/img/N_FXTURE/6_s.jpg',
      'src/assets/img/N_FXTURE/7_s.jpg',
    ],
    githubUrl: ''
  },
  {
...
The virtual reality project "transmorphosis" is a 360° VR video that deals with the situation how a world could look like, that has been completely overhauled by humans towards themselves. It further raises the questions how the relationships between people and their environment and nature would develop under these new circumstances. To emphasize the notion that for many advocates of the Anthropocene hypothesis, the main culprits, the western industrialized nations and their "technocratic elite[s]" are—I consciously chose "white" skin color for this project.`,
    technologies: ['Blender'],
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/transmorphosis/2_s.jpg',
    detailImages: ['src/assets/img/transmorphosis/1_s.jpg','src/assets/img/transmorphosis/2_s.jpg','src/assets/img/transmorphosis/3_s.jpg','src/assets/img/transmorphosis/4_s.jpg','src/assets/img/transmorphosis/5_s.jpg','src/assets/img/transmorphosis/6_s.jpg','src/assets/img/transmorphosis/7_s.jpg','src/assets/img/transmorphosis/8_s.jpg','src/assets/img/transmorphosis/9_s.jpg'],
    githubUrl: 'https://github.com/yourusername/project1'
  },
  {
    id: '[PART]',
...
Painting by Dennis Henning. Sound by Samuele Nestola. Project was realized in Unity and Blender.`,
    ...
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/[part]/1_s.jpg',
    detailImages: ['src/assets/img/[part]/1_s.jpg','src/assets/img/[part]/2_s.jpg','src/assets/img/[part]/3_s.jpg','src/assets/img/[part]/4_s.jpg','src/assets/img/[part]/5_s.jpg','src/assets/img/[part]/6_s.jpg','src/assets/img/[part]/7_s.jpg','src/assets/img/[part]/8_s.jpg','src/assets/img/[part]/9_s.jpg'],
    githubUrl: 'https://github.com/yourusername/project1'
  }
  ,
  {
...
We curated a selection of the artists works for the exhibition ourselves as part of the project. If the user is interested in further works by the artists there is the option of being forwarded directly to the artist's Instagram accounts.
    ...
    technologies: ['Unity',],
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/shift_space/1.png',
    detailImages: [
      'src/assets/img/shift_space/1.png',
      'src/assets/img/shift_space/2.png',
      'src/assets/img/shift_space/11.png',
      'src/assets/img/shift_space/12.png',
      'src/assets/img/shift_space/14.png',
  ...
  },
  {
    ...
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/Color_City/1.jpg',
    detailImages: [
      'src/assets/img/Color_City/1.jpg',
      'src/assets/img/Color_City/2.jpg',
      'src/assets/img/Color_City/3.jpg',
      'src/assets/img/Color_City/4.jpg',
    ],
    githubUrl: ''
  },
  {
    ...
    technologies: ['TouchDesigner'],
    layout: 'standard',
    thumbnailUrl: 'src/assets/img/gloomy_prospects/5.png',
    detailImages: [
      'src/assets/img/gloomy_prospects/4.jpg',
      'src/assets/img/gloomy_prospects/5.png',
      'src/assets/img/gloomy_prospects/Inside_portfolio_eng.jpg',
      'src/assets/img/gloomy_prospects/outside_3_final.png',
    ],
    githubUrl: ''
  }
