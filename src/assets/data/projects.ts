...
`,
    technologies: ["Unity", "AR"],
    layout: "video",
    thumbnailUrl: "/img/mh/BuchDerZeit.png",
...
`,
    technologies: ["Unity", "AR"],
    layout: "video",
    thumbnailUrl: "/img/mh/Honka.png",
    videoUrl: "https://www.youtube.com/embed/8IWW6t6Y5zo?si=DrBvGKZqyW-T7tzC",
    detailImages: [
      "/img/mh/GPS.png",
      "/img/mh/HHHonka-1.png",
      "/img/mh/HHHonka-2.png",
      "/img/mh/HHHonka-3.png",
      "/img/mh/HHHonka-4.png",
      "/img/mh/HHHonka-AR0.png",
    ],
...
Advanced augmented reality with image detection enhances immersion by triggering riddle logic and accurately placing 3D objects in the environment. Players scan specific markers or clues, activating hidden puzzles and animations that respond to their actions. This dynamic interaction turns the surroundings into an evolving landscape, creating a memorable experience where solving each challenge propels the story forward in this Unity-powered journey through historical investigation.`,
    technologies: ["Unity", "AR"],
    layout: "video",
    thumbnailUrl: "/img/mh/IBDWM_head.png",
    ...
    detailImages: [
      ...
      "/img/mh/IBDWM-R3.png",
      "/img/mh/IBDWM-R1.png",
      "/img/mh/IBDWM-AR0.png",
      "/img/mh/IBDWM-AR1.png",
      "/img/mh/IBDWM-AR2.png",
      "/img/mh/IBDWM-AR3.png",
    ],
...
LiDAR sensor system that captures the player movements, translating them into real-time gameplay elements. The installation features generative visuals and audio-reactive lighting created in TouchDesigner, projected across the space using a multi-projector setup.
  ...
  - Run from side to side: The user has to run from side to side to collect as much points as possible in a certain time frame.
    ...
    layout: "video",
    thumbnailUrl:"/img/SpacialARGames/corre/4.png",
    videoUrl: "https://www.youtube.com/embed/8ECLjSvQmgQ?si=icuIO5hmLXfGgju2",
    detailImages: [
      "/img/SpacialARGames/setup/1.png",
      "/img/SpacialARGames/setup/2.png",
      "/img/SpacialARGames/setup/td5.png",
      "/img/SpacialARGames/setup/td6.png",
      "/img/SpacialARGames/corre/1.png",
      "/img/SpacialARGames/corre/2.png",
      "/img/SpacialARGames/corre/3.png",
      "/img/SpacialARGames/corre/5.png",
      "/img/SpacialARGames/corre/7.png",
      "/img/SpacialARGames/bubbles/1.png",
      "/img/SpacialARGames/bubbles/2.png",
      "/img/SpacialARGames/bubbles/3.png",
      "/img/SpacialARGames/lava/1.png",
      "/img/SpacialARGames/lava/2.png",
      "/img/SpacialARGames/lava/3.png",
      "/img/SpacialARGames/blocks/1.png",
      "/img/SpacialARGames/blocks/2.png",
      "/img/SpacialARGames/blocks/3.png",
...
This self-guided format allows for exploration at individual pace and preference—whether solo or in groups—democratizing access to cultural knowledge without the constraints of scheduled tour times. Each stop along the journey reveals another layer of your community's unique identity, fostering deeper connection and appreciation among all who participate in this digital cultural expedition.`,
...

  {
    ...
    layout: "video",
    thumbnailUrl: "/img/Refracta/1.JPG",
  ...
  },
  {
    ...
    layout: "video",
    thumbnailUrl: "/img/levoxtrip/Inferno.png",
  ...
  },
  {
    ...
    technologies: ["Javascript", "P5.js"],
    layout: "video",
    thumbnailUrl: "/img/levoxtrip/ColoringCode.png",
...
This project has be exhibited at the ars electronica satellite event 2021 in Berlin.`,
    ...
    detailImages: [
      ...
      "/img/sensus_autem_machina/7_sensus_ars7.png",
      "/img/sensus_autem_machina/7_sensus_ars8.png",
    ],
  },
  {
    id: "Did they meet",
...
The project was developed in collaboration with Marina Engelhardt and Nora Schiller.`,
    ...
    layout: "standard",
    thumbnailUrl: "/img/Poetic_interfaces/7.jpg",
    detailImages: [
      "/img/Poetic_interfaces/7.jpg",
      "/img/Poetic_interfaces/1.jpg",
      "/img/Poetic_interfaces/2.jpg",
      "/img/Poetic_interfaces/3.png",
    ],
  },
  {
    id: "InterPortfolio",
    ...
    technologies: ["TouchDesigner"],
    layout: "video",
    thumbnailUrl: "/img/int_portfolio/1.jpg",
    videoUrl: "https://player.vimeo.com/video/766090078?h=486626679e",

    detailImages: [
      "/img/int_portfolio/1s.jpg",
      "/img/int_portfolio/2s.jpg",
      "/img/int_portfolio/3s.jpg",
      "/img/int_portfolio/4s.jpg",
      "/img/int_portfolio/5s.jpg",
      "/img/int_portfolio/6s.jpg",
      "/img/int_portfolio/7s.jpg",
      "/img/int_portfolio/8s.jpg",
    ],
  },
  {
    id: "Bursting glass",
    ...
    layout: "video",
    thumbnailUrl: "/img/bursting_glas/6.jpg",
    videoUrl: "https://www.youtube.com/embed/ktTrWckY2iY",
    detailImages: [
      "/img/bursting_glas/1.jpg",
      "/img/bursting_glas/2.jpg",
      "/img/bursting_glas/3.jpg",
      "/img/bursting_glas/5.jpg",
      "/img/bursting_glas/6.jpg",
    ],
  },
  {
    id: "N_FXTURE",
    ...
    layout: "video",
    thumbnailUrl: "/img/N_FXTURE/4_s.jpg",
    videoUrl:
      "https://player.vimeo.com/video/775036275?h=ffae6baa70&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479",
    detailImages: [
      "/img/N_FXTURE/1_s.jpg",
      "/img/N_FXTURE/2_s.jpg",
      "/img/N_FXTURE/3_s.jpg",
      "/img/N_FXTURE/4_s.jpg",
      "/img/N_FXTURE/5_s.jpg",
      "/img/N_FXTURE/6_s.jpg",
      "/img/N_FXTURE/7_s.jpg",
    ],
  },
  {
    id: "transmorphosis",
...
The virtual reality project "transmorphosis" is a 360° VR video that deals with the situation how a world could look like, that has been completely overhauled by humans towards themselves. It further raises the questions how the relationships between people and their environment and nature would develop under these new circumstances. To emphasize the notion that for many advocates of the Anthropocene hypothesis, the main culprits, the western industrialized nations and their "technocratic elite[s]" are—I consciously chose "white" skin color for this project.`,
    technologies: ["Blender"],
    layout: "video",
    thumbnailUrl: "/img/transmorphosis/2_s.jpg",
    videoUrl: "https://www.youtube.com/embed/m72GJQdn4LQ?si=t0BZTZ_bD1Esy9_L",
    detailImages: [
      "/img/transmorphosis/1_s.jpg",
      "/img/transmorphosis/2_s.jpg",
      "/img/transmorphosis/3_s.jpg",
      "/img/transmorphosis/4_s.jpg",
      "/img/transmorphosis/5_s.jpg",
      "/img/transmorphosis/6_s.jpg",
      "/img/transmorphosis/7_s.jpg",
      "/img/transmorphosis/8_s.jpg",
      "/img/transmorphosis/9_s.jpg",
    ],
...
We curated a selection of the artists works for the exhibition ourselves as part of the project.
    ...
    detailImages: [
      ...
      "/img/shift_space/11.png",
      "/img/shift_space/12.png",
      "/img/shift_space/14.png",
    ],
  ...
  },
  {
    ...
    detailImages: [
      ...
      "/img/Color_City/3.jpg",
      "/img/Color_City/4.jpg",
    ],
  },
  {
    ...
    technologies: ["TouchDesigner", "Installation"],
    layout: "standard",
    thumbnailUrl: "/img/gloomy_prospects/5.png",
    detailImages: [
      "/img/gloomy_prospects/4.jpg",
      "/img/gloomy_prospects/5.png",
      "/img/gloomy_prospects/Inside_portfolio_eng.jpg",
      "/img/gloomy_prospects/outside_3_final.png",
    ],
  },
];
